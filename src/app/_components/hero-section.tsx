...
const HeroSection = () => {
    ...
    return (
        <section className=" py-14 bg-[url('../../public/assets/bg-image.svg')] bg-cover bg-center bg-no-repeat   "
        >
            <div className=" container mx-auto relative ">
                ...
                >
                    {/* Main Content */}
                    <div className="relative z-10 flex flex-col items-center justify-center max-w-5xl  px-4 md:px-8">
                    ...
                    <motion.div variants={itemVariants} className="  flex flex-col relative md:flex-row justify-between  gap-6 md:gap-20 items-center max-w-5xl mx-auto px-4 md:px-8">
                        <motion.div
