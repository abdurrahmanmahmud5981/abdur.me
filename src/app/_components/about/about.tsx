...
const AboutSection = () => {
    ...
    return (
        <section className=" bg-[url('../../public/assets/about-bg.svg')] bg-cover bg-center bg-no-repeat">
            <div className="space-y-8 container mx-auto py-10 relative ">
                {/*  */}
                <div className="flex justify-end max-w-5xl ">
                    <div className='flex items-center'>
                        <span className=" border-2 border-black dark:border-white rounded-full p-2.5">
                            <ArrowDown size={20} />
                        </span>
                        <span className="border-2 border-black dark:border-white rounded-full px-5 py-2.5">About</span>
                    </div>
                </div>
